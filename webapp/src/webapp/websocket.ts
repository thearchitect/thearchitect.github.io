...
// export type OnMessage = (data: (ArrayBuffer | string)) => void
//
...
// }
//
// export abstract class AutoWebSocket {
//     protected constructor(o: AutoWebSocketBaseOptions) {
//         this._socket = new (class extends AutoWebSocketBase{
//             constructor(o: AutoWebSocketBaseOptions) {
//                 super(o)
//             }
//
...
//             }
//
//             protected disconnected(ev: CloseEvent): void {
//             }
//         })(o)
//     }
//
//     private _socket: AutoWebSocketBase
//
//     private _messageHandler: (EventListenerOrEventListenerObject | null) = null
//
//     connected(): void {
//         this._socket.socket.binaryType = 'arraybuffer'
//         this._messageHandler = (evt: MessageEvent) => {
//             this.onMessage(evt.data)
//         }
//         this._socket.socket.addEventListener('message', this._messageHandler)
//     }
//
//     public onMessage(cb: OnMessage): void {
//
//     }
//
//
//     protected disconnected(ev: CloseEvent): void {
//         this.socket.removeEventListener('message', this._messageHandler)
//     }
//
// }
